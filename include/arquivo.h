...
void salvar_registros_de_jogadores_binario(string nome_arq, no_t *lista);//string nome_arq, no_t *ptr_lista_rh);
void salvar_registros_de_jogos_binario(string nome_arq, not_t *lista);
void ler_registros_de_jogadores_binario(string nome_arq, lista_jogadores_t *lista);//string nome_arq, lista_t *lista_rh);
...
void exportar_dados_jogos_para_arquivo_texto(string nome_arq, not_t *lista);//string nome_arq, no_t *lista_rh);
void exportar_dados_jogadores_para_arquivo_csv(string nome_arq, no_t *lista);//string nome_arq, no_t *lista_rh);
